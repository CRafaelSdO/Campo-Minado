...
//Carregando fontes
	ALLEGRO_FONT *font2 = al_load_ttf_font("fonts/retro.ttf", 40, 0);
	ALLEGRO_FONT *font1 = al_load_ttf_font("fonts/retro.ttf", 110, 0);
	ALLEGRO_FONT *font3 = al_load_ttf_font("fonts/retro.ttf", 45, 0);
	ALLEGRO_FONT *font4 = al_load_ttf_font("fonts/retro.ttf", 30, 0);
...
//Carregando eventos
	...
	while(!done)
	{
		...
		al_draw_text(font1, Branco, screenwidth/2 - 350, screenheight/10 - 50, ALLEGRO_ALIGN_CENTRE, "RANKING");
		al_draw_text(font4, Branco, screenwidth/2 - 350, screenheight/10 + 60, ALLEGRO_ALIGN_CENTRE, "Digite seu nome aqui");
		al_draw_text(font4, Branco, screenwidth/2 - 350, screenheight/10 + 100, ALLEGRO_ALIGN_CENTRE, "para saber sua colocacao");
...
i ++;
al_draw_text(font3, Branco, screenwidth/2 - 290, screenheight/4 + (distancia*i) + 80, ALLEGRO_ALIGN_CENTRE, colocacao);
al_draw_text(font3, BrightRed, screenwidth/2 - 190, screenheight/4 + (distancia*i) + 80, ALLEGRO_ALIGN_CENTRE, loadRanking[i - 1].nome);
al_draw_text(font3, Branco, screenwidth/2 + 20, screenheight/4 + (distancia*i) + 80, ALLEGRO_ALIGN_CENTRE, "TEMPO:");
al_draw_text(font3, Electric, screenwidth/2 + 200, screenheight/4 + (distancia*i) + 80, ALLEGRO_ALIGN_CENTRE, stringTempo);
...
al_draw_text(font2, Branco, screenwidth /3 + 200, screenheight / 3 - 90, ALLEGRO_ALIGN_CENTRE, searchField);
...
al_draw_text(font3, Branco, screenwidth/2 - 290, screenheight/4 + 80, ALLEGRO_ALIGN_CENTRE, colocacao);
al_draw_text(font3, BrightRed, screenwidth/2 - 190, screenheight/4 + 80, ALLEGRO_ALIGN_CENTRE, loadRanking[find].nome);
al_draw_text(font3, Branco, screenwidth/2 + 20, screenheight/4 + 80, ALLEGRO_ALIGN_CENTRE, "TEMPO:");
al_draw_text(font3, Electric, screenwidth/2 + 200, screenheight/4 + 80, ALLEGRO_ALIGN_CENTRE, stringTempo);
