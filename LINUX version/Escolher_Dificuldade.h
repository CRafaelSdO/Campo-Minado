int choose(int screenwidth, int screenheight, ALLEGRO_DISPLAY *display, ALLEGRO_BITMAP *backgr, ALLEGRO_BITMAP *bomba)
{
  ...
  //Carregando eventos
	...
	while(!done)
	{
		...
		al_draw_text(font2, Branco2, screenwidth/2, screenheight/altura + distancia, ALLEGRO_ALIGN_CENTRE, "FACIL");
		al_draw_text(font2, Branco3, screenwidth/2, screenheight/altura + distancia*2, ALLEGRO_ALIGN_CENTRE, "MEDIO");
		al_draw_text(font2, Branco4, screenwidth/2, screenheight/altura + distancia*3, ALLEGRO_ALIGN_CENTRE, "DIFICIL");
