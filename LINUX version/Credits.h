int credits(int screenwidth, int screenheight, ALLEGRO_DISPLAY *display, ALLEGRO_BITMAP *backgr, ALLEGRO_BITMAP *bomba)
{
  ...
  //Carregando fontes
	...
	ALLEGRO_FONT *font1 = al_load_ttf_font("fonts/retro3d.ttf", 150, 0);
  ...
  //Carregando eventos
    ...
    //Nossos nomes
		al_draw_text(font2, Branco, screenwidth/2, screenheight/altura , ALLEGRO_ALIGN_CENTRE, "Cicero Rafael");
		al_draw_text(font2, Branco, screenwidth/2, screenheight/altura + distancia, ALLEGRO_ALIGN_CENTRE, "Lucas Ribeiro Raggi");
		al_draw_text(font2, Branco, screenwidth/2, screenheight/altura + distancia*2, ALLEGRO_ALIGN_CENTRE, "Nelson Gomes Neto");
		al_draw_text(font2, Branco, screenwidth/2, screenheight/altura + distancia*3, ALLEGRO_ALIGN_CENTRE, "Thiago");
